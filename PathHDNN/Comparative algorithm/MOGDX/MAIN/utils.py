...
def data_parsing(DATA_PATH, MODALITIES, TARGET, INDEX_COL, LABEL_FILE):
    datModalities = {}
    meta = pd.DataFrame()
    ...
    # 初始化 meta 数据框
    datMeta = labels[[TARGET]].copy()
    datMeta['diagnosis_label'] = labels[TARGET]  # 将 diagnosis 列复制到 diagnosis_label 列
